...
import { createAutomation, getAutomation, updateAutomation, getAllAutomations, deleteAutomation, toggleAutomation } from "../controllers/automation.controller.js";
...
router.patch("/:id/toggle", isAuthenticated, toggleAutomation);
